...
@section('content')
    <div class="flex justify-between border-b-2 border-gray-500">
        <h1 class="py-2 text-3xl max-sm:text-x">Orders</h1>
        <a href="/createorder" type="button" class="text-white bg-blue-700 p-0 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-6 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Create Orders</a>
