...
@section('content')
    <div class="flex justify-between border-b-2 border-gray-500">
        <div>
            <h1 class="py-2 text-3xl max-sm:text-x">Create Account</h1>
        </div>
        <div>
    ...
    <div class="mb-4 border-b border-gray-200 dark:border-gray-700 mt-5">
        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
            ...
            <li class="mr-2" role="presentation">
                <button class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="SA-tab" data-tabs-target="#SA" type="button" role="tab" aria-controls="SA" aria-selected="false">Shipping Address</button>
            </li>
        </ul>
    </div>
    <div id="myTabContent">
        <form action="">
            <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="general" role="tabpanel" aria-labelledby="general-tab">
                <div class="grid grid-cols-1">
                    ...
                    <div class="mb-6 md:w-1/2">
                        ...
                        <input type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Price">
                    </div>
                    <div class="mb-6 md:w-1/2">
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Last Name</label>
                        <input type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="RRP">
                    </div>
                    <div class="mb-6 md:w-1/2">
                        <label class="block mb-2 tbext-sm font-medium text-gray-900 dark:text-white">Role</label>
            ...
            <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="SA" role="tabpanel" aria-labelledby="SA-tab">
                <div class="grid grid-cols-1">
                    <div class="mb-6 md:w-1/2">
